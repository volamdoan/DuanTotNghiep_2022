...
<img class="wave" src="{{ asset('dangnhap/assets/img/wave.png') }}">
	<div class="container">
		<div class="img">
			<img src="{{ asset('dangnhap/assets/img/verif.svg') }}">
		</div>
        ...
        <input type="hidden" name="token" value="{{ $token }}">
				...
				<h2 class="title">{{ __('Đặt lại mật khẩu') }}</h2>
           		...
           		<div class="input-div pass">
           		   ...
           		   <div class="div">
                           <input id="password" placeholder="Mật khẩu" type="password" class="input form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
