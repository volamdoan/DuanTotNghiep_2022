...
<head>
    ...
    <link href='//theme.hstatic.net/1000306633/1000891824/14/check_out.css?v=360' rel='stylesheet' type='text/css' media='all' />
    ...
    <div class="banner">
        <div class="wrap">
            <a href="/" class="logo">
                ...
                <h1 class="logo-text">GENZ FASHION</h1>
    ...
    <button class="order-summary-toggle order-summary-toggle-hide">
        <div class="wrap">
            <div class="order-summary-toggle-inner">
                ...
                <div class="order-summary-toggle-total-recap" data-checkout-payment-due-target="45500000">
                    <span class="total-recap-final-price">455,000₫</span>
                </div>
            </div>
        </div>
    </button>
                            ...
                            <div class="order-summary-section order-summary-section-product-list" data-order-summary-section="line-items">
                                <table class="product-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="product" data-product-id="1043023881" data-variant-id="1094101311">
                                            <td class="product-image">
                                                <div class="product-thumbnail">
                                                    <div class="product-thumbnail-wrapper">
                                                        <img class="product-thumbnail-image" alt="GLOSSY TEE" src="//product.hstatic.net/1000306633/product/glossy_tee_blue_c82607ea9dad4ee3a4afe797ffdf11d8_small.jpg" />
                                                    </div>
                                                    <span class="product-thumbnail-quantity" aria-hidden="true">1</span>
                                                </div>
                                            </td>
                                            <td class="product-description">
                                                <span class="product-description-name order-summary-emphasis">GLOSSY TEE</span>
                                            ...
                                            <td class="product-price">
                                                <span class="order-summary-emphasis">420,000₫</span>
                                            </td>
                                        </tr>
                                    ...
                                    <tbody>
                                        <tr class="total-line total-line-subtotal">
                                            ...
                                            <td class="total-line-price">
                                                <span class="order-summary-emphasis" data-checkout-subtotal-price-target="42000000">
                                                    420,000₫
                                                </span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr class="total-line total-line-shipping">
                                            ...
                                            <td class="total-line-price">
                                                <span class="order-summary-emphasis" data-checkout-total-shipping-target="3500000">
                                    ...
                                    <tfoot class="total-line-table-footer">
                                        <tr class="total-line">
                                            ...
                                            <td class="total-line-name payment-due">
                                                ...
                                                <span class="checkout_version" display:none data_checkout_version="23">
                                                </span>
                                            </td>
                                        </tr>
                                    </tfoot>
                            ...
                            <div class="section">
                                ...
                                <div class="section-content section-customer-information no-mb">
                                    ...
                                    <p class="section-content-text">
                                        Bạn đã có tài khoản?
                                        <a href="/account/login?urlredirect=%2Fcheckouts%2Fc8234316125d4c648f86fe891496e0ca%3Fstep%3D1">Đăng nhập</a>
                                    </p>
                                                    ...
                                                    <div class="field field-show-floating-label field-required  field-third  ">
                                                        <div class="field-input-wrapper field-input-wrapper-select">
                                                            ...
                                                            <select class="field-input" id="customer_shipping_ward" name="customer_shipping_ward">
                                                                ...
                                                                <option data-code="27643" value="27643">Thị trấn Nhà Bè</option>
                                            ...
                                            <div class="content-box">
                                                ...
                                                <div class="content-box-row">
                                                    <div class="radio-wrapper">
                                                        <label class="radio-label" for="shipping_rate_id_1000089929">
                                                            <div class="radio-input">
                                                                <input id="shipping_rate_id_1000089929" class="input-radio" type="radio" name="shipping_rate_id" value="1000089929" checked />
                                                            </div>
                                                ...
                                                <div class="radio-wrapper content-box-row">
                                                    <label class="radio-label" for="payment_method_id_941686">
                                                        <div class="radio-input payment-method-checkbox">
                                                            <input type-id='1' id="payment_method_id_941686" class="input-radio" name="payment_method_id" type="radio" value="941686" checked />
                                                        </div>
