...
<section class="page__title-area pt-30 pb-0">
    ...
    font-weight: 400;
    line-height: 1;
    margin-bottom: 20px;">CHÍNH SÁCH ĐỔI TRẢ</h3>
                </div>
</section>
        ...
        <div class="row justify-content-center">
            <div class="col-xxl-8 col-xl-10">
                <div class="about__history-wrapper">
                    <p class="about__history-text">Nhằm giúp quý khách an tâm chọn lựa cho mình một sản phẩm ưng ý nhất và phục vụ khách hàng chu đáo, GenzStore thông báo chương trình đổi trả cho các sản phẩm và đơn hàng như sau:</p>
                    <div class="about__history-title-area">
                        <span class="about__history-title-pre">1. Thời gian đổi trả</span>
                    </div>
                        <p>+ Trong vòng 03 ngày được tính kể từ ngày mua hàng (tại cửa hàng) hoặc ngày nhận hàng (khi mua online).</p>
                        <div class="about__history-title-area">
                        <span class="about__history-title-pre">2. Điều kiện đổi trả: </span>
                       <p>
                       Khách hàng chỉ có thể đổi sản phẩm khi đáp ứng đủ 03 điều kiện sau:<br>
                        ...
                        - Sản phẩm phải còn nguyên vẹn, nguyên nhãn mác, mã vạch , chưa qua sử dụng, giặt ủi, không có mùi lạ và chưa sửa chữa.<br>
                        - Sản phẩm không nằm trong các chương trình ưu đãi, giảm giá.
                       </p>
                    </div>
                    <div class="about__history-title-area">
                        <span class="about__history-title-pre">3. Quy trình đổi trả: </span>
                       <p>
                       Cùng mã sản phẩm: Chỉ đổi size, không đổi màu<br>
                    (Tham khảo) [Dưới đây là phần tham khảo về quy trình đổi trả:<br>
                    + Đổi tại cửa hàng:<br>
                    Bước 1: Gửi mail về địa chỉ support@GenzStore.vn để được hỗ trợ<br>
                    Bước 2: Đóng gói sản phẩm cẩn thận có kèm hóa đơn mua hàng, mã vận chuyển (nếu mua online)<br>
                    Bước 3: Đến trực tiếp cửa hàng GenzStore để nhân viên hỗ trợ đổi sản phẩm.<br>
                    + Đổi hàng qua chuyển phát nhanh:<br>
                    Bước 1: Gửi mail về địa chỉ support@GenzStore.vn để được hỗ trợ<br>
                    Bước 2: Đóng gói sản phẩm cẩn thận có kèm hóa đơn mua hàng, mã vận đơn (nếu mua Online)<br>
                    Bước 3: Gửi hàng về địa chỉ: 45 Phan Chu Trinh, Phường Bến Thành, Quận 1, Thành phố Hồ Chí Minh và chờ bộ phận CSKH xác nhận khi nhận hàng.<br>
                    Bước 4: Nhận lại sản phẩm đổi hàng theo đường chuyển phát nhanh.
                       </p>
                    </div>
                    <div class="about__history-title-area">
                        <span class="about__history-title-pre">4. LƯU Ý: </span>
                       <p>
                       - GenzStore chỉ hỗ trợ tối đa một sản phẩm được đổi một lần, không hỗ trợ đổi hàng đối với sản phẩm đã đổi một lần trước đó <br>
                        - GenzStore chỉ hỗ trợ đổi Sản phẩm trong cùng một mã sản phẩm,<br>
                    Trường hợp trên GenzStore chỉ đổi size, không đổi màu:
                       </p>
                    </div>
                </div>
            </div>
