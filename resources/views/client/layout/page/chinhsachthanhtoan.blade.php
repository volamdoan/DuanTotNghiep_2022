...
<section class="page__title-area pt-30 pb-0">
    ...
    font-weight: 400;
    line-height: 1;
    margin-bottom: 20px;">PHƯƠNG THỨC THANH TOÁN</h3>
                </div>
</section>
        ...
        <div class="row justify-content-center">
            <div class="col-xxl-8 col-xl-10">
                <div class="about__history-wrapper">
                    <p class="about__history-text">- Với tiêu chí không ngừng nỗ lực để trải nghiệm mua hàng của Quý khách diễn ra thuận tiện hơn, GenzStore hiện hỗ trợ 2 hình thức thanh toán tại tất cả các hệ thống cửa hàng và website online www.GenzStore.com sau:</p>
                    <div class="about__history-title-area">
                        <span class="about__history-title-pre">1. Mua trực tiếp tại cửa hàng: </span>
                    </div>
                        <p>+ Thanh toán bằng tiền mặt</p>
                        <div class="about__history-title-area">
                        <span class="about__history-title-pre">2. Mua hàng trên mạng:</span>
                        <p>+ Thanh toán bằng tiền mặt qua ship COD</p>
                        <p>- Quý Khách hàng vui lòng kiểm tra hàng hóa và các thanh toán mà GenzStore đã xác nhận tại Đơn hàng trước khi thanh toán.</p>
                        <p>- Số tiền Quý Khách hàng phải thanh toán cho GenzStore chính là Số tiền cần thanh toán đã trừ mã giảm giá (nếu có) và cộng phí vận chuyển (nếu có), thể hiện trên website ở bước “Thanh toán”.</p>
                    </div>
                </div>
            </div>
        </div>
