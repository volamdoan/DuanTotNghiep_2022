...
<section class="page__title-area pt-30 pb-0">
    ...
    font-weight: 400;
    line-height: 1;
    margin-bottom: 20px;">CHÍNH SÁCH GIAO NHẬN – VẬN CHUYỂN</h3>
                </div>
</section>
        ...
        <div class="row justify-content-center">
            <div class="col-xxl-8 col-xl-10">
                <div class="about__history-wrapper">
                    <p class="about__history-text">Nhằm thực hiện giao hàng tới tất cả các tỉnh thành trên toàn quốc cho khách hàng đã đặt hàng online tại GenzStore.vn.</p>
                    <div class="about__history-title-area">
                        <span class="about__history-title-pre">1. Thời gian vận chuyển</span>
                    </div>
                        <p>Đơn hàng của quý khách sẽ được GenzStore chuẩn bị và giao hàng trong vòng từ 2 - 5 ngày làm việc, tùy thuộc vào khoảng cách địa lý hoặc yêu cầu của quý khách.
                        </p>
                        <p>- Đơn hàng có thể được gửi tới địa chỉ do quý khách chọn (nhà riêng, cơ quan).</p>
                        <div class="about__history-title-area">
                        <span class="about__history-title-pre">2. Phí vận chuyển: </span>
                       <p>
                       Phí vận chuyển của đơn hàng được tính theo địa điểm nhận hàng của quý khách hàng, thường dao động trong khoảng 30.000 - 40.000 đồng tùy theo khu vực. <br>
                       ...
                       + Thanh toán chuyển khoản/ thanh toán trực tuyến cho GenzStore bao gồm tiền hàng và tiền vận chuyển.<br>
                       Quý khách hàng có thể kiểm tra trực tiếp phí vận chuyển khi tiến hành đặt hàng tại GenzStore.vn
                       </p>
                    </div>
                    <div class="about__history-title-area">
                        <span class="about__history-title-pre">3. Tra cứu thông tin & Liên hệ</span>
                       <p>
                       Để kiểm tra thông tin, trạng thái đơn hàng, quý khách vui lòng gửi mail tới địa chỉ support@GenzStore.vn hoặc nhắn tin với bộ phận hỗ trợ của GenzStore trên Facebook & Instagram.
                       </p>
                    </div>
                </div>
            </div>
